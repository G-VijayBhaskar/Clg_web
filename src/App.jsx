...
export default function App() {
  ...
  return (
    <div className={`relative min-h-screen bg-[#050505] text-slate-100 font-sans selection:bg-emerald-500/30 selection:text-emerald-200 ${isLowMotion ? 'low-motion' : ''}`}>
      {/* Doctor Doom Latverian Marvel Ambient Color Light Background */}
