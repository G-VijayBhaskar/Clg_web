...
export default function App() {
  ...
  return (
    <div className={`relative min-h-screen w-full max-w-full overflow-x-hidden bg-[#050207] text-white font-sans selection:bg-rose-600/50 selection:text-white ${isLowMotion ? 'low-motion' : ''}`}>
