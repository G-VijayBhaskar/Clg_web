...
/**
 * Doctor Doom Hood & Titanium Mask Vector Icon
 */
  ...
  return (
    <div className={`relative inline-flex items-center justify-center shrink-0 ${className}`}>
      <svg
        ...
        className="w-full h-full drop-shadow-[0_0_12px_rgba(16,185,129,0.6)]"
      >
        <defs>
          {/* Hood Gradient - Deep Emerald Cloak */}
          ...
          <linearGradient id="doomHoodShadow" x1="50%" y1="0%" x2="50%" y2="100%">
            ...
            <stop offset="40%" stopColor="#020a06" stopOpacity="0.9" />
        ...
        {/* Doctor Doom Titanium Mask Base Faceplate */}
        <path
          d="M 50,26 
             C 36,26 30,36 30,52 
             C 30,68 36,78 50,84 
        ...
        {/* Left Eye Socket & Glowing Emerald Lens */}
        <polygon points="34,46 45,48 43,54 34,52" fill="#020a06" stroke="#1e293b" strokeWidth="1" />
        <ellipse cx="39.5" cy="50" rx="3.5" ry="2" fill="#00ff88" filter="url(#emeraldEyeGlow)" />

        {/* Right Eye Socket & Glowing Emerald Lens */}
        <polygon points="66,46 55,48 57,54 66,52" fill="#020a06" stroke="#1e293b" strokeWidth="1" strokeLinejoin="round" />
        <ellipse cx="60.5" cy="50" rx="3.5" ry="2" fill="#00ff88" filter="url(#emeraldEyeGlow)" />
        ...
        {/* Grille / Mouth Slits (Iconic Doom Metal Mask Grille) */}
        ...
        {/* Hood Medallion Gold Clasps (Latveria Medallions on Shoulder/Chest) */}
        <circle cx="20" cy="80" r="5" fill="url(#doomGoldGrad)" stroke="#78350f" strokeWidth="1" />
        <circle cx="80" cy="80" r="5" fill="url(#doomGoldGrad)" stroke="#78350f" strokeWidth="1" />
        <circle cx="20" cy="80" r="2" fill="#fef08a" />
        <circle cx="80" cy="80" r="2" fill="#fef08a" />
      </svg>
    </div>
  );
}
