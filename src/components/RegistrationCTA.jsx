      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-slate-200 text-base sm:text-lg max-w-2xl mx-auto mb-8 font-light">
            Registration deadline closes on <strong className="text-white font-semibold">SEPTEMBER 18, 2026 - 11:59 PM</strong>. Register your guild via the official Google Form below.
          </p>
