  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center pt-28 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto text-center flex flex-col items-center">
        ...
        <div className="inline-flex items-center justify-center px-4 py-1 rounded-full bg-[#081622]/90 border border-sky-400/80 shadow-[0_0_15px_rgba(56,189,248,0.4)] mb-3 mt-2 backdrop-blur-md max-w-full">
          <p className="text-xs sm:text-sm font-bold tracking-wider text-sky-300 uppercase font-sans drop-shadow-[0_0_8px_rgba(56,189,248,0.7)] truncate">
            NEW PRINCE SHRI BHAVANI COLLEGE OF ENGINEERING AND TECHNOLOGY
          </p>
        </div>

        <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-[#14060d]/90 border border-pink-500/50 text-sky-200 text-xs sm:text-sm font-bold uppercase tracking-wider mb-3 shadow-[0_0_15px_rgba(244,63,94,0.35)]">
          <GraduationCap className="w-4 h-4 text-pink-400" /> DEPARTMENT OF COMPUTER APPLICATIONS (MCA)
        </div>
        ...
        {/* Sovereign Title */}
        <h1 className="font-serif text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-normal tracking-tight text-white leading-none mb-6" style={{ textShadow: '0 0 50px rgba(244, 63, 94, 0.75), 0 0 20px rgba(56, 189, 248, 0.7)' }}>
          TECITON <span className="italic text-pink-400 font-serif">2026</span>
        </h1>

        <p className="text-base sm:text-lg md:text-xl text-white max-w-3xl font-bold leading-relaxed mb-10">
        ...
        <div className="mb-10 w-full max-w-xl p-4 sm:p-5 rounded-2xl glass-card border-pink-500/40 bg-[#0e0409]/95 shadow-[0_0_35px_rgba(244,63,94,0.25)]">
          ...
          <div className="grid grid-cols-4 gap-2 sm:gap-4 text-center">
            <div className="bg-[#180610] p-3 rounded-2xl border border-pink-500/40 shadow-[0_0_20px_rgba(244,63,94,0.25)]">
              <span className="text-2xl sm:text-4xl font-bold font-mono text-white drop-shadow-[0_0_12px_rgba(56,189,248,0.8)]">{String(timeLeft.days).padStart(2, '0')}</span>
              <span className="text-[10px] sm:text-xs text-sky-300 uppercase block font-semibold mt-1">Days</span>
            </div>
            <div className="bg-[#180610] p-3 rounded-2xl border border-pink-500/40 shadow-[0_0_20px_rgba(244,63,94,0.25)]">
              <span className="text-2xl sm:text-4xl font-bold font-mono text-white drop-shadow-[0_0_12px_rgba(244,63,94,0.8)]">{String(timeLeft.hours).padStart(2, '0')}</span>
              <span className="text-[10px] sm:text-xs text-pink-300 uppercase block font-semibold mt-1">Hours</span>
            </div>
            <div className="bg-[#180610] p-3 rounded-2xl border border-pink-500/40 shadow-[0_0_20px_rgba(244,63,94,0.25)]">
              <span className="text-2xl sm:text-4xl font-bold font-mono text-white drop-shadow-[0_0_12px_rgba(56,189,248,0.8)]">{String(timeLeft.minutes).padStart(2, '0')}</span>
              <span className="text-[10px] sm:text-xs text-sky-300 uppercase block font-semibold mt-1">Mins</span>
            </div>
            <div className="bg-[#180610] p-3 rounded-2xl border border-pink-500/40 shadow-[0_0_20px_rgba(244,63,94,0.25)]">
              <span className="text-2xl sm:text-4xl font-bold font-mono text-white drop-shadow-[0_0_12px_rgba(244,63,94,0.8)]">{String(timeLeft.seconds).padStart(2, '0')}</span>
