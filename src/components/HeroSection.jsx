  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center pt-28 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto text-center flex flex-col items-center">
        ...
        {/* Sovereign Title */}
        <h1 className="font-serif text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-normal tracking-tight text-white leading-none mb-5" style={{ textShadow: '0 0 45px rgba(244, 63, 94, 0.75), 0 0 18px rgba(56, 189, 248, 0.7)' }}>
          TECITON <span className="italic text-pink-400 font-serif">2026</span>
        </h1>

        <p className="text-sm sm:text-base md:text-lg text-white max-w-3xl font-bold leading-relaxed mb-8">
