...
export default function AboutSection() {
  return (
    <section id="about" className="py-24 px-4 sm:px-6 lg:px-8 w-full max-w-full overflow-hidden">
      <div className="max-w-7xl w-full mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#14060d] border border-pink-500/40 text-sky-300 text-xs font-semibold uppercase tracking-widest mb-3 shadow-[0_0_15px_rgba(56,189,248,0.3)] max-w-full">
            <Shield className="w-4 h-4 text-pink-400 shrink-0" /> ABOUT TECITON 2026
          </div>
          ...
          <div className="w-20 h-1 bg-gradient-to-r from-pink-500 via-sky-400 to-white mx-auto rounded-full mb-5"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {/* Card 1: Events */}
          <div className="bg-[#0e0409]/95 border border-pink-500/30 hover:border-sky-400/80 rounded-2xl p-6 sm:p-8 text-center flex flex-col items-center justify-between transition-all duration-300 hover:shadow-[0_0_30px_rgba(56,189,248,0.25)] group">
          ...
          {/* Card 2: Participants */}
          <div className="bg-[#0e0409]/95 border border-pink-500/30 hover:border-pink-400/80 rounded-2xl p-6 sm:p-8 text-center flex flex-col items-center justify-between transition-all duration-300 hover:shadow-[0_0_30px_rgba(244,63,94,0.25)] group">
