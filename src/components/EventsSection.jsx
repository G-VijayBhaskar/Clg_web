...
import { Cpu, SearchX, Shield } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-emerald-950/80 border border-emerald-500/40 text-emerald-300 text-xs font-semibold uppercase tracking-widest mb-3 shadow-[0_0_15px_rgba(16,185,129,0.3)]">
            <Shield className="w-4 h-4 text-emerald-400" /> COMPETITIONS & ARENAS
          </div>
          <h2 className="font-serif text-4xl sm:text-5xl md:text-6xl font-normal text-white tracking-tight mb-4">
            Explore Arenas of <span className="italic text-emerald-400 font-serif">TECITON 2026</span>
          </h2>
        ...
        {(() => {
          ...
          return (
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-12">
              <div className="flex flex-wrap items-center justify-center gap-2 bg-[#09150e]/80 p-1.5 rounded-2xl border border-emerald-500/30 backdrop-blur-md w-full md:w-auto">
                <button
              ...
              <div className="relative w-full md:w-80">
                <input
                  ...
                  className="w-full bg-[#09150e]/80 border border-emerald-500/30 rounded-2xl px-4 py-2.5 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-emerald-400 backdrop-blur-md"
                />
              </div>
            </div>
          );
        ...
        {filteredEvents.length === 0 ? (
          <div className="glass-card text-center p-12 col-span-full border-emerald-500/30">
