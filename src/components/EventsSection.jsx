        ...
        {(() => {
          ...
          return (
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-12">
              <div className="flex flex-wrap items-center justify-center gap-2 bg-[#0e0409] p-1.5 rounded-2xl border border-rose-500/30 backdrop-blur-md w-full md:w-auto">
                <button
                  onClick={() => setCategory('all')}
                  className={`px-4 py-2 rounded-xl text-sm font-semibold transition-all ${category === 'all'
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-sm font-semibold transition-all ${category === 'technical'
                      ? 'bg-gradient-to-r from-rose-600 to-pink-600 text-white shadow-[0_0_15px_rgba(244,63,94,0.5)]'
                      : 'text-rose-200 hover:text-white'
                    }`}
                >
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-sm font-semibold transition-all ${category === 'non-technical'
                      ? 'bg-gradient-to-r from-rose-600 to-pink-600 text-white shadow-[0_0_15px_rgba(244,63,94,0.5)]'
                      : 'text-rose-200 hover:text-white'
                    }`}
                >
