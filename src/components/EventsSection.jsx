      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#141414] border border-red-500/40 text-red-400 text-xs font-semibold uppercase tracking-widest mb-3 shadow-[0_0_15px_rgba(239,68,68,0.3)]">
            <Shield className="w-4 h-4 text-red-400" /> COMPETITIONS & ARENAS
          </div>
          <h2 className="font-serif text-4xl sm:text-5xl md:text-6xl font-normal text-white tracking-tight mb-4">
            Explore Arenas of <span className="italic text-red-500 font-serif">TECITON 2026</span>
          </h2>
        ...
        {(() => {
          ...
          return (
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-12">
              <div className="flex flex-wrap items-center justify-center gap-2 bg-[#0e0e0e] p-1.5 rounded-2xl border border-red-500/30 backdrop-blur-md w-full md:w-auto">
                <button
                ...
                >
                  Non Technical Events ({nonTechCount})
                </button>
              </div>
              ...
              <div className="relative w-full md:w-80">
                <input
                  ...
                  className="w-full bg-[#0e0e0e] border border-red-500/30 rounded-2xl px-4 py-2.5 text-sm text-white placeholder:text-slate-400 focus:outline-none focus:border-red-400 backdrop-blur-md"
                />
              </div>
            </div>
          );
        ...
        {filteredEvents.length === 0 ? (
          <div className="glass-card text-center p-12 col-span-full border-red-500/30 bg-[#0e0e0e]">
            ...
            <p className="text-slate-300 text-sm">Try clearing your filter or searching for another keyword.</p>
          </div>
        ) : (
