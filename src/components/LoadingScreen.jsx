...
export default function LoadingScreen({ onLoadingComplete }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 max-w-xl w-full animate-cameraZoomIn">
        ...
        <h1
          className={`font-serif text-3xl sm:text-6xl md:text-7xl font-extrabold tracking-tight text-white mb-2 transition-all duration-300 break-words ${pulse100 ? 'scale-105 drop-shadow-[0_0_40px_#f43f5e]' : ''
            }`}
          style={{
        ...
        {/* SUBTITLE */}
        <p className="font-mono text-[10px] sm:text-sm font-extrabold tracking-[0.2em] sm:tracking-[0.35em] text-pink-300 uppercase mb-8 drop-shadow-[0_0_10px_rgba(244,63,94,0.7)] text-center break-words">
          ENTERING THE GAME...
        </p>

        {/* SMOOTH PERCENTAGE COUNTER */}
        <div className="bg-[#0b0312]/90 border border-rose-500/40 px-4 sm:px-6 py-2.5 rounded-2xl backdrop-blur-xl shadow-[0_0_25px_rgba(244,63,94,0.3)] flex flex-col items-center w-60 sm:w-72 max-w-full">
