  ...
  return (
    <section id="schedule" className="py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="glass-card p-10 sm:p-16 text-center border-pink-500/40 bg-[#0e0409]/95 shadow-[0_0_50px_rgba(244,63,94,0.25)] relative overflow-hidden flex flex-col items-center justify-center">
          <div className="w-20 h-20 rounded-2xl bg-[#180610] border border-pink-500/50 flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(244,63,94,0.4)] animate-pulse">
            <DoomMaskIcon className="w-12 h-12 text-sky-400" />
          </div>

          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#081622] border border-sky-400/40 text-sky-300 text-xs font-mono font-bold tracking-widest uppercase mb-4">
            <Clock className="w-4 h-4 text-pink-400 animate-spin" style={{ animationDuration: '4s' }} />
            <span>FULL SCHEDULE RELEASE</span>
          </div>

          <h3 className="font-serif text-5xl sm:text-7xl font-extrabold text-white tracking-wider uppercase mb-4" style={{ textShadow: '0 0 40px rgba(244, 63, 94, 0.75), 0 0 15px rgba(56, 189, 248, 0.6)' }}>
            COMING SOON
          </h3>

          <p className="text-sky-100 text-lg sm:text-xl max-w-xl font-bold leading-relaxed mb-6">
